...
# to the model. The loss-distribution is then compared    #
...
copulaGF <- function(model,size=10000,fitLoss="modelLoss"){
    ...
    class(output) <- "copulaGF";
    return(output);
}

print.copulaGF <- function(x, ...){
